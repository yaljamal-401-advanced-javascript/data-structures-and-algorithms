...
describe('FuzzBuzzTree', () => {
  it('if passing tree', () => {
    ...
    expect(fizzBuzzTree(tree)).toEqual({
      'root': {
        'left': { 'left': { 'left': null, 'right': null, 'value': 4 }, 'right': { 'left': null, 'right': null, 'value': 'buzz' }, 'value': 2 },
        'right': {
          'left': { 'left': null, 'right': null, 'value': 'Fizz' }, 'right': { 'left': null, 'right': null, 'value': 7 },
          'value': 'Fizz'
        }, 'value': 1
      }
    });
